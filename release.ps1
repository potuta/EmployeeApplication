...
$appName = "EmployeeApplication" # 👈 Replace with your application project name.
$projDir = "C:\Users\cyy\Desktop\coding\c#\EmployeeApplication" # 👈 Replace with your project directory (where .csproj resides).
